...
\begin{figure}[h]
	...
	\caption{Normalized device coordinates for our triangle}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{vertexattributepointer.png}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{formula.png}
\end{figure}
...
\begin{minipage}{0.6\textwidth}
	\centering
	\includegraphics[width=0.8\textwidth]{sampler.png}
\end{minipage}
